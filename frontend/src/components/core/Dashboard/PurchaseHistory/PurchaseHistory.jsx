        ...
        <>
          ...
          <div className="hidden lg:block my-8 text-richblack-5">
            <div className="flex rounded-t-lg bg-richblack-500 ">
              ...
              <p className="w-[15%] px-2 py-3">Purchase Date</p>
              <p className="w-[15%] px-2 py-3">Price</p>
              <p className="w-[15%] px-2 py-3">Status</p>
              <p className="w-[15%] px-2 py-3">Invoice</p>
            </div>
            {purchases.map((purchase, i, arr) => (
              ...
              >
                ...
                <div className="w-[15%] px-2 py-3">
                  <button
                    onClick={() => setSelectedOrder(purchase.orderDetails)}
                    className="flex items-center gap-2 text-sm font-medium text-yellow-50 hover:text-yellow-100"
                  >
            ...
            {purchases.map((purchase) => (
              <div key={purchase._id} className="bg-richblack-700 rounded-lg p-4 space-y-3">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <button
                    onClick={() => setSelectedOrder(purchase.orderDetails)}
                    className="flex items-center gap-2 text-sm font-medium text-yellow-50 hover:text-yellow-100 bg-richblack-800 px-3 py-2 rounded-md"
                  >
                    <FiDownload className="text-lg" />
                    Invoice
                  </button>
